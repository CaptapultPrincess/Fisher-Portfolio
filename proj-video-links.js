...
let reflectionHeader = document.querySelector(".main-header-reflection");
let reflectionText = document.querySelector(".main-text-reflection");
...
mainTwo.addEventListener('click', function(){
    ...
    document.querySelector(".desc-box").style.height = "auto";
    reflectionHeader.innerHTML = "Cake Bake"
    reflectionText.innerHTML = "Cake Bake is a simple and short game where your only task is to bake a cake. To do this, you select three ingredients, and my character does the rest. <br><br> Cake Bake was orginally made for a contest entry, but hit unexpected success when the Scratch Team decided to feature it on the main page. This lead to it getting more than 100,000 views. From that point on, I expanded the game, reaching 100 cakes. Even if its time on the main page is over, Cake Bake is still being played today. I will never forgot the day I opened scratch.mit's website and saw my game."
});
...
mainThree.addEventListener('click', function(){
    ...
    document.querySelector(".desc-box").style.height = "auto";
    reflectionHeader.innerHTML = "A Superhero Story"
    reflectionText.innerHTML = "Superhero Story is currently an incomplete game where your task is to run around as a superhero. However, daily routines change once you meet a strange girl who has more power than anyone else in the city. <br><br> Superhero Story is the project I am currently working on. There wasn't a huge gap between it and Princess Story, but my programming skills had vastly improved by then. This is actually an 2D open world game, that even saves your progress using a code. This game started right after Cake Bake's success, so there are many easter eggs of fans around the map."
});
